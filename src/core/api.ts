...
>(
  ...
  const [filters] = parseFilterArgs(arg2, arg3)
  return environment
    .getQueryCache()
    .getAll()
...
export function getQueryData<TData = unknown>(
  ...
  return findQuery<TData>(environment, queryKey, filters)?.state.data
}
...
export function getQueryState<TData = unknown, TError = undefined>(
  ...
  return findQuery<TData, TError>(environment, queryKey, filters)?.state
}
...
export function cancelQueries(
  environment: Environment,
  arg2?: QueryKey | QueryFilters,
  arg3?: QueryFilters | CancelOptions,
  arg4?: CancelOptions
): Promise<void> {
  const [filters, cancelOptions = {}] = parseFilterArgs(arg2, arg3, arg4)
...
export function invalidateQueries(
  ...
  arg3?: InvalidateQueryFilters | InvalidateOptions,
  arg4?: InvalidateOptions
): Promise<void> {
  const [filters, options] = parseFilterArgs(arg2, arg3, arg4)
...
export function refetchQueries(
  environment: Environment,
  arg2?: QueryKey | QueryFilters,
  arg3?: QueryFilters | RefetchOptions,
  arg4?: RefetchOptions
): Promise<void> {
  const [filters, options] = parseFilterArgs(arg2, arg3, arg4)
